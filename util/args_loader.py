...
def get_args():
    ...
    parser.add_argument('--model-arch', default='mobilenet', type=str, help='model architecture [resnet50]')
    
    parser.add_argument('--threshold_h', default=1.3360897541046144, type=float, help='sparsity level')
    parser.add_argument('--threshold_l', default=0.07878071814775467, type=float, help='sparsity level')
    
    parser.add_argument('--a', default=0.8, type=float, help='similiraity and variance')
    parser.add_argument('--k', default=1050, type=int, help='number of selected channels')
